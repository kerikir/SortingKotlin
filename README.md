...
coroutines (suspend fun, coroutine scope, launch). 
При 100 элементах последовательная быстрее в 45 раз.
При 100_000 элементах последовательная в 1,53 раза быстрее параллельной реализации.
При 1_000_000 элементах параллельная быстрее в 1,58 раз.
При 10_000_000 элементах происходит переполнение стека вызова функций.
